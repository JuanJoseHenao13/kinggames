{{-- Extiende el layout base para clientes --}}
...
<div class="space-y-8">
    {{-- Sección de encabezado con estilo gaming --}}
    {{-- Contenedor con fondo gradiente, bordes redondeados, sombras y efectos visuales --}}
    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-100 via-cyan-100 to-purple-100 dark:from-gray-900 dark:via-blue-900 dark:to-cyan-900 p-8 border border-cyan-300 dark:border-cyan-500/20 shadow-xl">
        {{-- Fondo decorativo con patrón SVG --}}
        <div class="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30"></div>
        {{-- Contenido principal del encabezado --}}
        <div class="relative z-10 flex items-center gap-4">
            {{-- Icono de recibo en un contenedor circular --}}
    ...
    {{-- Sección de tabla con estilo gaming --}}
                ...
                <tbody class="bg-white dark:bg-transparent">
                    ...
                    @forelse($transacciones as $transaccion)
                        ...
                        <tr class="group border-b border-gray-200 dark:border-gray-700/30 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-all duration-300">
                            {{-- Celda ID Transacción --}}
                            <td class="px-6 py-5">
                                <div class="flex items-center gap-3">
                                    {{-- Icono de hash en contenedor --}}
                    ...
                    @empty
                        {{-- Fila cuando no hay transacciones --}}
                        <tr>
                            <td colspan="4" class="px-8 py-16">
                                <div class="flex flex-col items-center space-y-6">
                                    {{-- Icono animado de carrito vacío --}}
                                    <div class="relative">
                    ...
                    {{-- Cierra el bucle de transacciones --}}
                    @endforelse
                </tbody>
            </table>
        </div>

        {{-- Pie de página decorativo de la tabla --}}
        <div class="h-2 bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-600"></div>
    </div> {{-- Cierra la sección de la tabla --}}
</div> {{-- Cierra el contenedor principal con espaciado --}}
